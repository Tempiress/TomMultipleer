class Tomato extends Phaser.GameObjects.Sprite 
{
    ...
    {
        this.socket = socket;
        if(this.body.oldPosition && (this.body.x !== this.body.oldPosition.x || this.body.y !== this.body.oldPosition.y))
        {          
            this.anims.play('tomato_walk');
            this.socket.emit('playerMovement', {x: this.body.x, y: this.body.y});
